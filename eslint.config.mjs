...
export default tseslint.config(
  {
    ignores: [
      ...
      'projects/tape/web/**',
      // ts-rs CODEGEN OUTPUT (tape's MessagePack bridge schemas). Each file
      // carries "This file was generated by ts-rs ... Do not edit this file
      // manually." Hand-fixing the strictTypeChecked stylistic findings
      // (consistent-type-definitions, array-type) would be overwritten on the
      // next `bridge-generate`; the generator owns this shape. Excluded from
      // the style lint as generated, non-authored source.
      '**/schemas/bridge/generated/**',
    ],
  },
